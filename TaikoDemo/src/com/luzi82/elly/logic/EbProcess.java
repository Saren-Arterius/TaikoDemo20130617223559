...
public abstract class EbProcess<T extends EbObject<L>, L extends EbLogic<L>> {
    ...
    public Map<String, Object> process(L aLogic, T aActor, Map<String, Object> aRequest)
            throws IllegalArgumentException, IllegalAccessException {
        final Class<?> clazz = getClass();
        final Field[] fieldAry = clazz.getFields();
        for (final Field field: fieldAry) {
        ...
        for (final Field field: fieldAry) {
            ...
            final String key = field.getName().substring(4);
