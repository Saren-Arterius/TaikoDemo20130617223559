...
public abstract class EbGame extends Game implements InputProcessor {

	EbScreen<?> mCurrentScreen;
	EbTouchTrace mTouchTrace;

	@Override
	public void create() {
		mTouchTrace = new EbTouchTrace();
	...
	public void setScreen(Screen aScreen) {
		...
		if (aScreen instanceof EbScreen) {
			mCurrentScreen = (EbScreen<?>) aScreen;
		} else {
			mCurrentScreen = null;
		}
	}
